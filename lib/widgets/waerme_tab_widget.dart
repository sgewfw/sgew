...
class _WaermeTabWidgetState extends State<WaermeTabWidget> {
  ...
  Widget _buildDesktopLayout() {
    return SizedBox(
      height: 600, // 🆕 Feste Höhe statt IntrinsicHeight
      child: Row(
        ...
        children: [
                ...
                return SingleChildScrollView(
                  child: DataTable(
                    ...
                    columns: [
                      DataColumn(
                        label: SizedBox(
                          width: isMobile ? 50 : 110,  // ← NEU: Feste Breite
                          child: Text(
                            'Quartal',
                            style: TextStyle(
                      ...
                      DataColumn(
                        label: SizedBox(
                          width: isMobile ? 45 : 110,  // ← NEU: Mehr Platz
                          child: Text(
                            isMobile ? 'Gas\n(yₙ)' : 'Anteil\nGas (yₙ)',
                            style: TextStyle(
                              fontWeight: FontWeight.normal,
                      ...
                      DataColumn(
                        label: SizedBox(
                          width: isMobile ? 50 : 110,  // ← NEU: Mehr Platz
                          child: Text(
                            'AP\nGas',
                            style: TextStyle(
                              fontWeight: FontWeight.normal,
                      ...
                      DataColumn(
                        label: SizedBox(
                          width: isMobile ? 55 : 110,  // ← NEU: Mehr Platz
                          child: Text(
                            isMobile ? 'AP\nΣ' : 'AP\nGesamt',
                            style: TextStyle(
                              fontWeight: FontWeight.normal,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Formel: AP Gesamt = (yₙ × AP_Gas) + ((1-yₙ) × AP_Strom)',
    ...
    return LineChart(
      LineChartData(
        ...
        titlesData: FlTitlesData(
          ...
          // 🆕 Bottom Titles für Quartale
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              showTitles: true,
              reservedSize: 32,
              interval: 3, // Jedes Quartal (alle 3 x-Einheiten)
              getTitlesWidget: (value, meta) {
